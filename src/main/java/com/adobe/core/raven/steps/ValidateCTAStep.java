...
public class ValidateCTAStep implements Tasklet {
        ...
        JobParameters jobParameters = chunkContext.getStepContext().getStepExecution().getJobParameters();
            ...
            String state = JobConstant.PASS;
                for (String ctaLink : CTALinksFromHtml) {
                    ...
                    String tagID = "";
                    try {
                        tagID = queryParameters.get(QAConstant.TRACKINGID).get(0);
                    ...
                    if (tagfullurl != null
                            && ctaLink != null
                            && validateService.compare(tagfullurl, ctaLink)) {
    ...
    private ArrayList<String> fetchRedirectedLinks(Elements links, ChunkContext chunkContext) {
        ...
        for(Element link: links){
            ...
            // System.out.println("tag :::::::::::: " + link.toString());
