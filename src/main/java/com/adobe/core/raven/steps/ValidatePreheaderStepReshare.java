...
public class ValidatePreheaderStepReshare implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        String preHeaderFromCgen = cgenService.fetchPreHeader(activityID,cgenContent);//debug

        ArrayList<Link> preHeader = new ArrayList<>();
        Link link = new Link();
        String state = JobConstant.PASS;
        if(validateService.compare(preHeaderFromCgen
